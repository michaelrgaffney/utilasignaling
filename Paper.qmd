...
When the fitness interests of signalers and receivers are aligned, i.e., there are no conflicts of interest, child signals of need are expected to be low cost, what @maynardsmith1995 refer to as "minimal signals," those whose cost is no greater than that needed to transmit the information effectively. In other words, although minimal signals might involve some cost (e.g., energy for a loud scream), they do not require any additional mechanism to enforce honesty.
...
<!-- [One dense paragraph on how what we have learned relates to what has been reported empirically in the past]
- Note: we did not mention declines with age in the introduction
- Vingerhoets' lab and their colleagues maintain crying is understudied with older children


[Move first sentence down to 468 and broaden? Or at least broaden? MacFarlane's study of tantrums among Berkeley: declines from 5 to 12]

The cries and fussing of young infants increases until 6 weeks, peaking in some populations at over two hours a day, and then declines steadily until 12-16 weeks [@vermillet2022; @barr1991].
-->
