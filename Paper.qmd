...
Frequencies of caregiver response to the last instance of child signaling by the cause of the signaling. Categories of causes were based on cluster analysis of more fine-grained cause variables. See @sfig-cause-clustering for cluster dendrogram and @sfig-sumtab-causes for the frequencies of causes and caregiver responses.
:::
