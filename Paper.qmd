...
Frequencies of caregiver response to the last instance of child signaling by the cause of the signaling. Categories of causes were based on cluster analysis of more fine-grained cause variables. See sixxxxxx for cluster and sitabxxxxxxx for the frequencies of causes and caregiver responses.
:::
...
(temporarilly moved here) Tantrums were present among older children and might be an under-appreciated way by which children signal for increased support. Most studies of tantrums involve children under 4 years old or older children with disruptive mood dysregulation disorder, likely due to their greater prevalence in these populations (cite). However, multiple studies which included older children from non-clinical populations have found similar evidence of tantrums [@macfarlane1962; @barbarin1999; @ward2013; @osterman2010; @goodenough1931; @bhatia1990], as have ethnographic studies [@ward2013; @lessa1950; @dennis1940].
