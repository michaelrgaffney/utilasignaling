...
kable(custom.summarize(modeldf, longform_dict[1:31])) %>% kable_styling()
```
...
Correlation matrix of the frequencies of signals/states covered in the study with sex, child age, and the frequency of conflict between children and primary caretakers. For a more complete correlation matrix of study variables see SIxxxxxxx.
:::
...
\[Am I missing anything about the significance of this being a relative measure. Could faking drive up the costs in ways everyone signals similarly\]
...
One reason for this might be that neighborhood quality affects the amount of adversity children face, thereby increasing their neediness.
